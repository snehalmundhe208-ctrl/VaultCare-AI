    ...
    <div className="min-h-screen bg-cream-grid flex flex-col font-sans select-none scroll-smooth">
       ...
       {/* Section: How VaultCare-AI works */}
        <section id="how-it-works" className="scroll-mt-24 space-y-10">
          <div className="text-center max-w-3xl mx-auto space-y-3">
            ...
            rounded-full bg-[#FAF5EC] text-[#916D41] border border-[#E3CF9B] text-xs font-bold">
            ...
            <p className="text-base text-[#666666] font-medium leading-relaxed">
             Four simple steps to transform your scattered lab reports into intelligent, actionable health insights. 
            </p>
            </div>
        ...
        {/* SECTION 1: Features Section (Why VaultCare AI) */}
        <section id="platform" className="scroll-mt-24 space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-3">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#FAF5EC] text-[#916D41] border border-[#E3CF9B] text-xs font-bold">
              <Cpu className="w-3.5 h-3.5 text-[#C9A574]" /> Comprehensive Platform
            </div>
            ...
            <p className="text-base text-[#666666] font-medium leading-relaxed">
              Everything you need to take complete ownership of your lifelong medical history.
            </p>
          </div>
            ...
            {features.map((feat, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-xl font-extrabold text-black">{feat.title}</h3>
                  <p className="text-xs text-[#666666] font-medium leading-relaxed">{feat.desc}</p>
                </motion.div>
              );
            })}
          </div>
        ...
        {/* SECTION 2: Security & Privacy Section */}
          ...
          <div className="bg-[#E8E2D5] rounded-3xl p-8 md:p-14 border border-[#DCD5C6] shadow-vault-lg space-y-8 relative overflow-hidden">
            <div className="max-w-3xl space-y-3">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white text-[#916D41] border border-[#E3CF9B] text-xs font-bold">
                <Lock className="w-3.5 h-3.5 text-[#C9A574]" /> Enterprise-Grade Protection
              </div>
              <h2 className="text-3xl md:text-5xl font-black text-black tracking-tight">
                Built for Lifelong Medical Privacy & Security
              </h2>
              <p className="text-base text-[#444444] font-medium leading-relaxed">
                Your sensitive health data is protected by enterprise-grade encryption, role-based access control, and strict privacy standards.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-2xl border border-[#E5E0D5] shadow-sm space-y-3">
                ...
                <h3 className="text-base font-extrabold text-black">AES 256 Encryption</h3>
                <p className="text-xs text-[#666666] leading-relaxed">All documents uploaded to Supabase Storage are encrypted both in transit and at rest.</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-2xl border border-[#E5E0D5] shadow-sm space-y-3">
                ...
                <h3 className="text-base font-extrabold text-black">Supabase RLS & RBAC</h3>
                <p className="text-xs text-[#666666] leading-relaxed">Strict Row Level Security (RLS) ensures only verified patients and assigned doctors can read files.</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-2xl border border-[#E5E0D5] shadow-sm space-y-3">
                ...
                <h3 className="text-base font-extrabold text-black">Zero Data Selling</h3>
                <p className="text-xs text-[#666666] leading-relaxed">We never sell, monetize, or train open models on your private medical diagnostic files.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-12">
          ...
          <div className="bg-white p-8 rounded-3xl border border-[#E5E0D5] shadow-vault-card grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="space-y-1">
              <div className="text-3xl md:text-4xl font-black text-black">10,000+</div>
              <div className="text-xs text-[#777777] font-semibold">Reports Organized</div>
            </div>
            <div className="space-y-1">
              <div className="text-3xl md:text-4xl font-black text-black">500+</div>
              <div className="text-xs text-[#777777] font-semibold">Verified Doctors</div>
            </div>
            <div className="space-y-1">
              <div className="text-3xl md:text-4xl font-black text-black">99.98%</div>
              <div className="text-xs text-[#777777] font-semibold">System Uptime</div>
            </div>
            <div className="space-y-1">
              <div className="text-3xl md:text-4xl font-black text-black">84/100</div>
              <div className="text-xs text-[#777777] font-semibold">Avg Health Score</div>
            </div>
          </div>
            ...
            {testimonials.map((t, idx) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 pt-4 border-t border-[#FAF8F5]">
                  ...
                  <div>
                    <h4 className="text-sm font-extrabold text-black">{t.name}</h4>
                    <p className="text-[11px] text-[#777777] font-semibold">{t.role}</p>
                  </div>
                </div>
              </motion.div>
            ))}
        ...
        <section id="pricing" className="scroll-mt-24 space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-3">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#FAF5EC] text-[#916D41] border border-[#E3CF9B] text-xs font-bold">
              <Sparkles className="w-3.5 h-3.5 text-[#C9A574]" /> Transparent Plans
            </div>
            ...
            <p className="text-base text-[#666666] font-medium leading-relaxed">
              Choose the plan that fits your personal or family health record needs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-3xl border border-[#E5E0D5] shadow-vault-card flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="space-y-1">
                  <h3 className="text-xl font-extrabold text-black">Basic Vault</h3>
                  <p className="text-xs text-[#777777]">Free forever for individuals</p>
                </div>
                ...
                <ul className="space-y-3 text-xs text-[#333333] pt-2">
                  <li className="flex items-center gap-2 font-semibold"><Check className="w-4 h-4 text-[#C9A574]" /> Up to 10 report uploads</li>
                  <li className="flex items-center gap-2 font-semibold"><Check className="w-4 h-4 text-[#C9A574]" /> Basic biometrics trend charts</li>
                  <li className="flex items-center gap-2 font-semibold"><Check className="w-4 h-4 text-[#C9A574]" /> Health Timeline access</li>
                </ul>
              </div>
              <button
                onClick={() => onNavigate('role-select')}
            ...
            <div className="bg-[#1A1A1A] text-white p-8 rounded-3xl border-2 border-[#C9A574] shadow-vault-lg flex flex-col justify-between space-y-6 relative transform md:-translate-y-2">
              ...
              <div className="space-y-4">
                <div className="space-y-1">
                  <h3 className="text-xl font-extrabold text-white">VaultCare Pro</h3>
                  <p className="text-xs text-gray-400">Complete AI health analysis</p>
                </div>

                <div className="text-4xl font-black text-white">
                  ₹999 <span className="text-xs font-normal text-gray-400">/ year</span>
                </div>

                <ul className="space-y-3 text-xs text-gray-200 pt-2">
                  <li className="flex items-center gap-2 font-semibold"><Check className="w-4 h-4 text-[#C9A574]" /> Unlimited report uploads</li>
                  <li className="flex items-center gap-2 font-semibold"><Check className="w-4 h-4 text-[#C9A574]" /> AI Health Summary & Q&A assistant</li>
                  <li className="flex items-center gap-2 font-semibold"><Check className="w-4 h-4 text-[#C9A574]" /> Server-side PDF export via pdfkit</li>
                  <li className="flex items-center gap-2 font-semibold"><Check className="w-4 h-4 text-[#C9A574]" /> Razorpay protected checkout</li>
                </ul>
              </div>

              <button
                onClick={() => triggerPlanCheckout('VaultCare Pro Plan', 999)}
            ...
            <div className="bg-white p-8 rounded-3xl border border-[#E5E0D5] shadow-vault-card flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="space-y-1">
                  <h3 className="text-xl font-extrabold text-black">Family Vault</h3>
                  <p className="text-xs text-[#777777]">Up to 5 family members</p>
                </div>

                <div className="text-3xl font-black text-black">
                  ₹1,999 <span className="text-xs font-normal text-gray-500">/ year</span>
                </div>

                <ul className="space-y-3 text-xs text-[#333333] pt-2">
                  <li className="flex items-center gap-2 font-semibold"><Check className="w-4 h-4 text-[#C9A574]" /> 5 Patient vault profiles</li>
                  <li className="flex items-center gap-2 font-semibold"><Check className="w-4 h-4 text-[#C9A574]" /> Unlimited OCR & AI extractions</li>
                  <li className="flex items-center gap-2 font-semibold"><Check className="w-4 h-4 text-[#C9A574]" /> Dedicated doctor sharing portal</li>
                </ul>
              </div>

              <button
                onClick={() => triggerPlanCheckout('Family Vault Plan', 1999)}
        ...
        {/* SECTION 5: Full-Width Light Cream CTA Banner */}
        <section className="bg-[#E8E2D5] rounded-3xl p-10 md:p-16 text-center text-black space-y-6 shadow-vault-lg border border-[#DCD5C6] relative overflow-hidden">
          <div className="max-w-2xl mx-auto space-y-4">
            ...
            <p className="text-sm md:text-base text-[#444444] font-medium leading-relaxed">
              Turn years of scattered paperwork into a single intelligent timeline you and your doctor can rely on.
            </p>
          </div>
      ...
      <footer className="bg-[#E8E2D5] text-[#555555] border-t border-[#DCD5C6] mt-20 pt-16 pb-12 select-none">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-5 gap-10 pb-12 border-b border-[#DCD5C6]">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-xs text-[#555555] leading-relaxed max-w-sm font-medium">
              VaultCare AI is an AI-powered personal health record platform designed to organize scattered lab reports, scans, and prescriptions into a unified, encrypted health timeline.
            </p>
            <div className="flex items-center gap-4 text-[#555555] pt-2">
              <a href="#" className="hover:text-[#C9A574] transition-colors"><Twitter className="w-4 h-4" /></a>
              <a href="#" className="hover:text-[#C9A574] transition-colors"><Linkedin className="w-4 h-4" /></a>
              <a href="#" className="hover:text-[#C9A574] transition-colors"><Instagram className="w-4 h-4" /></a>
            </div>
          </div>

          {/* Col 2: Product */}
          <div className="space-y-3 text-xs">
            <h4 className="text-sm font-extrabold text-black uppercase tracking-wider">Product</h4>
            <ul className="space-y-2 font-medium">
              <li><a href="#platform" onClick={(e) => scrollToSection('platform', e)} className="hover:text-black transition-colors">Platform</a></li>
              <li><a href="#how-it-works" onClick={(e) => scrollToSection('how-it-works', e)} className="hover:text-black transition-colors">How it works</a></li>
              <li><a href="#security" onClick={(e) => scrollToSection('security', e)} className="hover:text-black transition-colors">Security</a></li>
              <li><a href="#pricing" onClick={(e) => scrollToSection('pricing', e)} className="hover:text-black transition-colors">Pricing</a></li>
            </ul>
          </div>

          {/* Col 3: Company */}
          <div className="space-y-3 text-xs">
            <h4 className="text-sm font-extrabold text-black uppercase tracking-wider">Company</h4>
            <ul className="space-y-2 font-medium">
              <li><a href="#" onClick={(e) => { e.preventDefault(); alert("VaultCare AI About Us page"); }} className="hover:text-black transition-colors">About Us</a></li>
              <li><a href="#" onClick={(e) => { e.preventDefault(); alert("VaultCare AI Careers"); }} className="hover:text-black transition-colors">Careers</a></li>
              <li><a href="#" onClick={(e) => { e.preventDefault(); alert("VaultCare AI Health Blog"); }} className="hover:text-black transition-colors">Blog</a></li>
              <li><a href="#" onClick={(e) => { e.preventDefault(); alert("Contact: support@vaultcare.ai"); }} className="hover:text-black transition-colors">Contact</a></li>
            </ul>
          </div>

          {/* Col 4: Legal */}
          <div className="space-y-3 text-xs">
            <h4 className="text-sm font-extrabold text-black uppercase tracking-wider">Legal</h4>
            <ul className="space-y-2 font-medium">
              <li><a href="#" onClick={(e) => { e.preventDefault(); alert("Terms of Service"); }} className="hover:text-black transition-colors">Terms of Service</a></li>
              <li><a href="#" onClick={(e) => { e.preventDefault(); alert("Privacy Policy"); }} className="hover:text-black transition-colors">Privacy Policy</a></li>
              <li><a href="#" onClick={(e) => { e.preventDefault(); alert("Cookie Policy"); }} className="hover:text-black transition-colors">Cookie Policy</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 pt-8 flex flex-col md:flex-row items-center justify-between text-xs text-[#777777] font-medium gap-4">
          <span>© 2026 VaultCare AI. All rights reserved.</span>
          <div className="flex gap-6">
            <a href="#" onClick={(e) => { e.preventDefault(); alert("Terms of Service"); }} className="hover:text-black">Terms</a>
            <a href="#" onClick={(e) => { e.preventDefault(); alert("Privacy Policy"); }} className="hover:text-black">Privacy</a>
          </div>
        </div>
      </footer>
          ...
          <div className="bg-white max-w-lg w-full rounded-3xl p-8 border border-[#E5E0D5] shadow-2xl relative animate-scaleUp">
            ...
            <div className="text-center mb-6">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#F5EDD5] text-[#916D41] text-xs font-bold mb-2">
                <Sparkles className="w-3.5 h-3.5" /> Razorpay Secured Checkout
              </div>
              <h2 className="text-2xl font-black text-black">Upgrade to {selectedPlan.name}</h2>
              <p className="text-sm text-[#666666] mt-1">Unlimited OCR extraction, AI Chat assistant & PDF export</p>
            </div>
            ...
            <div className="bg-[#FAF8F5] p-6 rounded-2xl border border-[#E5E0D5] mb-6 space-y-3">
              <div className="flex items-center gap-2 text-sm text-black font-semibold">
                <CheckCircle2 className="w-4 h-4 text-[#C9A574]" /> Unlimited report uploads (PDF/Images)
              </div>
              <div className="flex items-center gap-2 text-sm text-black font-semibold">
                <CheckCircle2 className="w-4 h-4 text-[#C9A574]" /> AI Health Summary & Risk Matrix
              </div>
              <div className="flex items-center gap-2 text-sm text-black font-semibold">
                <CheckCircle2 className="w-4 h-4 text-[#C9A574]" /> Server-side PDF export with pdfkit
              </div>
              <div className="flex items-center gap-2 text-sm text-black font-semibold">
                <CheckCircle2 className="w-4 h-4 text-[#C9A574]" /> Doctor consultation sharing link
              </div>
            </div>

           <div className="flex items-center justify-between mb-6">
              <div>
                <span className="text-3xl font-black text-black">₹{selectedPlan.price}</span>
            ...
            <button
              onClick={() => handleRazorpayPayment(selectedPlan.name, selectedPlan.price)}
